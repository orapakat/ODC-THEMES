...
<div class="artikel layanan">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form">
    <tr>
	  ...
	  <tr>
		  <td colspan="3" class="button" scope="col"><a href="<?php echo site_url("first/cetak_kk/$penduduk[id]/1"); ?>" target="_blank"><button type="button" class="waves-effect waves-light btn"><i class="fa fa-print"></i> CETAK KARTU KELUARGA</button></a></td>
    </tr>
  </table>
  <br />
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form" >
    ...
    <tr>
      <td colspan="3" class="button" scope="col"><a href="<?php echo site_url("first/cetak_biodata/$penduduk[id]"); ?>" target="_blank"><button type="button" class="waves-effect waves-light btn"><i class="fa fa-print"></i> CETAK BIODATA</button></a></td>
    </tr>
  </table>
  <br />
